        ...
        <div class="container">
            <div class="row">
                <div class="col-12 position-relative text-center">
                    <h1 class="mt-0 mb-1 text-white">COMPANY FINANCIAL REPORT</h1>
        ...
        <section class="py-5">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-10 mt-3 bg-white p-4 shadow">
                        ...
                        <form>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select id="inputState" class="form-select">
                                        ...
                                        <option>7 UP BOTTLING COMPANY PLC</option>
                                        <option>AG LEVENTIS NIGERIA PLC</option>
                                        <option>ABA TEXTILE MILLS PLC</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary">Get Financials</button>
                        </form>
                    </div>
                </div>
            </div>
