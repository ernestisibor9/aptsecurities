        ...
        <div class="container">
            <div class="row">
                <div class="col-12 position-relative text-center">
                    <h1 class="mt-0 mb-1 text-white">DAILY EQUITY MARKET REVIEW</h1>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <table class="table table-bordered table-responsive table-striped">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">2022-09-23 Equity Market Review</th>
                                    <td>
                                        <a href="./img/pdf-folder/pdflogo.png" download><img
                                                src="./img/pdf-folder/pdflogo.png" alt="" width="60px" height="60px">
                                        </a>
                                    </td>
                                    <td>
                                        <a href="./img/pdf-folder/pdfdown.png" download><img
                                                src="./img/pdf-folder/pdfdown.png" alt="" width="60px" height="60px">
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">2022-09-21 Equity Market Review</th>
                                    <td>
                                        <a href="./img/pdf-folder/pdflogo.png" download><img
                                                src="./img/pdf-folder/pdflogo.png" alt="" width="60px" height="60px">
                                        </a>
                                ...
                                <tr>
                                    <th scope="row">2022-09-20 Equity Market Review</th>
                                    <td>
                                        <a href="./img/pdf-folder/pdflogo.png" download><img
                                                src="./img/pdf-folder/pdflogo.png" alt="" width="60px" height="60px">
                                        </a>
