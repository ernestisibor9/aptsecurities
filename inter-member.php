        ...
        <div class="container">
            <div class="row">
                <div class="col-12 position-relative text-center">
                    <h1 class="mt-0 mb-1 text-white">Inter Member</h1>
                    ...
                    <div class="col-12 mt-3">
                        <div class="row row-cols-1 row-cols-md-1 row-cols-lg-1 gy-2 gy-md-2 gx-0 gx-md-2 gx-lg-4">
                            <div class="col d-flex align-items-start">
                                ...
                                <div>
                                    <h6 class="h6">INTER-MEMBER TRANSFER</h6>
                                    <p class="mb-2" style="text-align: justify;">
                                        Inter-member transfer refers to the transfer of an investor’s portfolio from one
                                        stockbroking firm to another
                                        stockbroking firm. This enables you have all your shares consolidated with one
                                        stockbroker.
                                    </p>
                                    <p>This process allows transfer for shares from either an active or Stockbroking
                                        house.
                                    </p>
                                    <h6 class="h6">HOW DO I TRANSFER MY SHARES FROM AN ACTIVE STOCKBROKING HOUSE TO APT
                                        SECURITIES AND FUNDS STOCKBROKERS?</h6>
                                    <ul>
                                        <li>Click here to open an account</li>
                                        <li>Completed inter-member transfer form.</li>
                                        <li>Three duly signed Authority letters addressed to CSCS, current broker and to
                                            APT Securities and Funds Stockbrokers notifying them of intention to move
                                            stocks
                                        </li>
                                        <li>Current CSCS statement with the other house</li>
                                        <li>Provide all necessary documents/items as may be required by your existing
                                            broker –Resident Stockbroker KYC, Utility
                                            Bill, ID Card and Passport photograph.
                                        </li>
                                    </ul>
                                    <h6 class="h6">
                                        <h6 class="h6">HOW DO I TRANSFER MY SHARES FROM AN ACTIVE STOCKBROKING HOUSE TO
                                            APT
                                            SECURITIES AND FUNDS STOCKBROKERS?</h6>
                                        <ul>
                                            <li>Click here to open an account</li>
                                            <li>Completed inter-member transfer form</li>
                                            <li>Three duly signed Authority letters addressed to CSCS, current broker
                                                and to APT Securities and Funds Stockbrokers notifying them of intention
                                                to move stocks
                                            </li>
                                            <li>Duly executed Counter indemnity form</li>
                                            <li>Complete KYC (current means of identification and utility bill within
                                                the last 3months)
                                            </li>
                                            <li>Six Months Relationship</li>
                                            <li>Evidence of stock(s) ownership such as any one of the first three
                                                <ol>
                                                    <li>purchase receipts</li>
                                                    <li>dividend warrant stubs</li>
                                                    <li>contract note from the broker</li>
                                                </ol>
                                            </li>
                                            <li>Physical Biometric data capturing at the office of CSCS or a notarized
                                                means of your valid ID
                                            </li>
                                            <li>
                                                Formal letter addressed to CSCS for collection of current CSCS statement
