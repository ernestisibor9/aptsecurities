        ...
        <div class="container">
            <div class="row">
                <div class="col-12 position-relative text-center">
                    <h1 class="mt-0 mb-1 text-white">Global Search</h1>
                    ...
                    <div class="col-12 mt-3">
                        <div class="row row-cols-1 row-cols-md-1 row-cols-lg-1 gy-2 gy-md-2 gx-0 gx-md-2 gx-lg-4">
                            <div class="col d-flex align-items-start">
                                ...
                                <div>
                                    <h6 class="h6">GLOBAL SEARCH FOR INVESTOR SHARES</h6>
                                    <p class="mb-2" style="text-align: justify;">
                                        This is a comprehensive search of an investor’s stocks across the capital
                                        market; brokerage firms and Registrars. This
                                        will reveal investor total portfolio in the Capital market
                                    </p>
