        ...
        <div class="container">
            <div class="row">
                <div class="col-12 position-relative text-center">
                    <h1 class="mt-0 mb-1 text-white">CAREERS</h1>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-10 mt-3 bg-white p-4 shadow">
                        ...
                        <p>
                            <a href="#" style="text-decoration: none; color:red">Register with us</a> <span>to receive
                                updates about when openings become
                                available</span>
                        </p>
                    </div>
                </div>
