        ...
        <div class="container">
            <div class="row">
                <div class="col-12 position-relative text-center">
                    <h1 class="mt-0 mb-1 text-white">Client Information Estate Account</h1>
                    ...
                    <div class="col-12 mt-3">
                        <div class="row row-cols-1 row-cols-md-1 row-cols-lg-1 gy-2 gy-md-2 gx-0 gx-md-2 gx-lg-4">
                            <div class="col d-flex align-items-start">
                                ...
                                <div>
                                    <h6 class="h6">CLIENT INFORMATION ESTATE ACCOUNT</h6>
                                    <p class="mb-2" style="text-align: justify;">
                                    <ol>
                                        <li>Last will and testament or letter of administration.</li>
                                        <li>Valid Means of Identification National ID Card International Passport
                                            Driver’s License
                                        </li>
                                        <li>Proof of Address i.e Utility Bill, Bank Account Statement, and Rental
                                            Agreement.</li>
                                        <li>Current Passport Photograph.</li>
                                        <li>Death Certificate of the deceased</li>
                                        <li>Newspaper Publication of the deceased.</li>
                                        <li>Authorized Signatories and Signature Mandate (if more than one claimants).
                                        </li>
                                        <li>Power of Attorney (if applicable) 9. Residence Permit (if applicable).</li>
                                    </ol>
                                    </p>
